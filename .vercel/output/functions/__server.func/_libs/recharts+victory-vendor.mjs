...
import { _ as require_react_dom, v as require_with_selector } from "./@tanstack/react-router+[...].mjs";
...
var Cross = (_ref) => {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$14(_ref, _excluded$14);
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		...
		var otherPathProps = _objectWithoutProperties$13(_svgPropertiesAndEven, _excluded$13);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var otherPathProps = _objectWithoutProperties$13(_svgPropertiesAndEven2, _excluded2$8);
		return /*#__PURE__*/ import_react.createElement("path", _extends$15({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, _x = _action$payload$coord.x, _y = _action$payload$coord.y, otherCoordinateProps = _objectWithoutProperties$12(_action$payload$coord, _excluded$12);
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$11(props, _excluded2$7);
...
function Label(outerProps) {
	...
	if (typeof content === "function") {
		...
		label = /*#__PURE__*/ (0, import_react.createElement)(content, _objectWithoutProperties$10(propsWithViewBox, _excluded2$6));
...
function LabelList(_ref) {
	var _ref$valueAccessor = _ref.valueAccessor, valueAccessor = _ref$valueAccessor === void 0 ? defaultAccessor : _ref$valueAccessor, restProps = _objectWithoutProperties$9(_ref, _excluded$9), dataKey = restProps.dataKey;
	restProps.clockWise;
	var id = restProps.id, textBreakAll = restProps.textBreakAll, zIndex = restProps.zIndex, others = _objectWithoutProperties$9(restProps, _excluded2$5);
...
function DotItem(_ref) {
	...
	_ref2.points;
	var props = _objectWithoutProperties$8(_ref2, _excluded$8);
	...
	reducers: {
		...
		updateXAxisHeight(state, action) {
			...
			if (axis) {
				...
				state.xAxis[id] = _objectSpread$8(_objectSpread$8({}, axis), {}, {
					height,
...
function AxisLine(axisLineProps) {
	...
	return /*#__PURE__*/ import_react.createElement("line", _extends$7({}, props, { className: clsx("recharts-cartesian-axis-line", get(axisLine, "className")) }));
}
/**
...
var Ticks = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	var tickLines = tickLineCoords.map((_ref2) => {
		...
		}, tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$7({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", get(tickLine, "className")) })));
	});
...
var CartesianAxisComponent = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var axisLine = props.axisLine, width = props.width, height = props.height, className = props.className, hide = props.hide, ticks = props.ticks, axisType = props.axisType, axisId = props.axisId, rest = _objectWithoutProperties$7(props, _excluded$7);
...
//#endregion
export { Tooltip as a, Area as i, YAxis as n, ResponsiveContainer as o, XAxis as r, AreaChart as t };
