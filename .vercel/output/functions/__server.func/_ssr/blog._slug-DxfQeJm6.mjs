...
import { t as Route } from "./blog._slug-CTLGJsv9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/blog._slug-DxfQeJm6.js
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The implication for a plotted community like Quantumrise Infra is quiet but material. Absorption in low-density villa plots historically lags apartments by four to six quarters. In corridors going through infrastructure repricing, the lag compresses. Plots that transacted at ₹6,500 per square foot in early 2024 are now moving at ₹8,200 without any change to the physical asset." }),
