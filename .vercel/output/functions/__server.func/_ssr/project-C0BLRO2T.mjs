...
import { a as RevealText, b as nearby, i as Parallax, o as SectionHeading, r as MagneticButton, t as Eyebrow, u as aerial_forest_default, x as plot_default, y as landscape_default } from "./site-Cuda1iA-.mjs";
import { t as EnquiryModal } from "./enquiry-modal-Ck6LNQU1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/project-C0BLRO2T.js
...
function Project() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "The Haven Estate" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MagneticButton, {
								variant: "gold",
								onClick: () => openEnquiry("The Haven Estate"),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					intro: "The Haven Estate is our flagship plotted residential community with a quieter planning language: usable land, clear internal movement and pockets of green space around daily life."
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MagneticButton, {
					variant: "gold",
					onClick: () => openEnquiry("The Haven Estate — Project Profile"),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					intro: "The Haven Estate focuses on the essentials buyers look for first: a clear residential layout, comfortable streets and a landscape-led setting."
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					intro: "Each plot at The Haven Estate is designed for your future home — with clear titles, underground utilities and a community design charter that protects your investment."
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-8",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MagneticButton, {
						variant: "primary",
						onClick: () => openEnquiry("The Haven Estate — Plots"),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MagneticButton, {
						variant: "gold",
						onClick: () => openEnquiry("The Haven Estate — Location"),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
						title: "The Haven Estate location map",
						width: "100%",
						height: "560",
						loading: "lazy",
					...
					children: nearby.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						onClick: () => openEnquiry(`The Haven Estate — ${item.name} (${item.category})`),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EnquiryModal, {
			...
			title: "Interested in The Haven Estate?",
