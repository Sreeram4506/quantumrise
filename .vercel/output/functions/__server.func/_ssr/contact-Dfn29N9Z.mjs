...
import { a as RevealText, f as brand, r as MagneticButton, t as Eyebrow } from "./site-Cuda1iA-.mjs";
import { n as object, r as string } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-Dfn29N9Z.js
...
function Contact() {
	...
	const onSubmit = (e) => {
		...
		const whatsappUrl = `https://wa.me/${brand.whatsapp.replace(/\D/g, "")}?text=${encodeURIComponent(msg)}`;
