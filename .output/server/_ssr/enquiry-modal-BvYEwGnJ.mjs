...
import { f as brand } from "./site-H_PIM-QR.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/enquiry-modal-BvYEwGnJ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var schema = object({
	name: string().trim().min(2, "Please enter your name").max(80),
	phone: string().trim().min(7, "Please enter a valid phone number").max(20),
	email: string().trim().email("Please enter a valid email").max(160).optional().or(literal("")),
	address: string().trim().min(5, "Please enter your address").max(200),
	message: string().trim().max(600).optional().or(literal(""))
});
function EnquiryModal({ open, onClose, title = "Interested in this project?", context = "" }) {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
						...
						stroke: "currentColor",
						strokeWidth: "2",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M1 1l12 12M13 1L1 13" })
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-2 font-display text-3xl leading-tight text-primary",
						children: title
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-sm text-muted-foreground",
						children: "Share your details and we'll connect you with our sales team on WhatsApp."
					})]
				}),
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "mb-1.5 block text-[10px] uppercase tracking-[0.28em] text-muted-foreground",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "mb-1.5 block text-[10px] uppercase tracking-[0.28em] text-muted-foreground",
								children: ["Your Address ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-destructive",
									children: "*"
								})]
							}),
							...
							errors.address && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-1 text-xs text-destructive",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							errors.message && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-1 text-xs text-destructive",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: submitting ? "Sending..." : "Send enquiry on WhatsApp"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-center text-[10px] text-muted-foreground/60",
							children: "Your details will be shared with our sales team via WhatsApp. No spam, ever."
						})
					]
				})
			]
